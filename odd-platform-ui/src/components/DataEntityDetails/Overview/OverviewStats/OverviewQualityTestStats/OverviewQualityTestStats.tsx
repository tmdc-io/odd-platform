                  ...
                  <Link
                    to={
                      location.pathname.includes('embedded')
                        ? `/embedded${dataEntityDetailsPath(dataset.id)}`
                        : dataEntityDetailsPath(dataset.id)
                    }
                  >
        ...
        <S.Overview item sx={{ mr: 4 }}>
          ...
          <Grid container>
            <Link
              to={
                location.pathname.includes('embedded')
                  ? `/embedded${dataEntityHistoryPath(qualityTest?.id)}`
                  : dataEntityHistoryPath(qualityTest?.id)
              }
            >
